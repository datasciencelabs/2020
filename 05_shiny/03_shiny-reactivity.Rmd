...
### Example
Let's look at a concrete example. This example also comes from [Mastering Shiny](https://mastering-shiny.org/basic-reactivity.html) (chapter 4) and the live app can be accessed [here](https://hadley.shinyapps.io/basic-reactivity-cs/).
