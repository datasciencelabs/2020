...
Setting `show.legend = FALSE` removes the legend, which is unnecessary now that all of the lines are gray. We can add the black average line by passing the new data frame into another call to `geom_line`. 
